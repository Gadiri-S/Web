...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Modern and affordable web solutions to allow your business to thrive</h1>
<span>Our web solutions are tailored to the need of businesses who understand the necessity of having an online presence to thrive in this new digital world.</span>

<div class="button-container" ><button   @click="nav('container-page')"  class="bu">See our solutions</button></div>
</div>
<img  v-motion-fade  src="../../assets/microsoft-edge-6CxMLmoyfGg-unsplash.jpg" class="hero-image" alt="">
    ...
    { name: 'description', content: description.value },
        { name: 'og:description', content: description.value},
         ...
         { name: 'og:image', content: image.value },
                  { name: 'og:url', content: "https://businessprowebsolutions.com/solutions" },
          { name: 'keywords', content: "https://businessprowebsolutions.com/solutions" },
...
const res = await axios.get('solution-page?populate=deep')
