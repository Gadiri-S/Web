...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">for all your questions and inquiries, please contact us!</h1>
<span>For all your questions and inquiries, please contact us by email or directly by phone.</span>

<div class="button-container" ><button   @click="nav('container-contact')"  class="bu">Contact us</button></div>
</div>
