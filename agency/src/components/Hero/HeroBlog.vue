...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Get our latest articles and news</h1>
<span>Get our latest news and articles concerning web development, business trends and tips to maximize your online presence!</span>

<div class="button-container" ><button   @click="nav('container-blog')"  class="bu">See our articles and news</button></div>
</div>
...
const res = await axios.get('blog-page?populate=deep')
