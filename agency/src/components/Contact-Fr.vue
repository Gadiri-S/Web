...
<h2>Pour toutes questions, veuillez nous contacter en remplissant le formulaire ou directement par téléphone.</h2>
...
<form ref="form" id="form" @submit.prevent="handleSubmit" enctype="multipart/form-data" >
      ...
      <div v-if="v$.firstname.$error" class="error" > <input type="text" placeholder="Champ obligatoire. Lettres seulement.*" v-model="firstname" name='firstname'  @blur="v$.firstname.$touch" required>
        
        </div>
        
        <div v-else> <input type="text" placeholder="Prénom*" v-model="firstname" name='firstname'  @blur="v$.firstname.$touch" required></div>



      <div v-if="v$.lastname.$error" class="error" > <input type="text" placeholder="Champ obligatoire. Lettres seulement.*" v-model="lastname" name='lastname'  @blur="v$.lastname.$touch" required>
        
        </div>
        
        <div v-else> <input type="text" placeholder="Nom de famille*" v-model="lastname" name='lastname'  @blur="v$.lastname.$touch" required></div>
      
      
        <div v-if="v$.business.$error" class="error" > <input type="text" placeholder="Champ obligatoire. Lettres et chiffres seulement.*" v-model="business" name='business'  @blur="v$.business.$touch" required>
        
        </div>
        
        <div v-else> <input type="text" placeholder="Nom de l'entreprise*" v-model="business" name='business'  @blur="v$.business.$touch" required></div>
              
              
    <div v-if="v$.email.$error" class="error" > <input type="email" placeholder="Champ obligatoire. Entrez un email valide.*" v-model="email" name='email'  @blur="v$.email.$touch" required>
    ...
    <div v-if="v$.tel.$error" class="error" > <input type="tel" placeholder="Champ obligatoire. Chiffres seulement.*" v-model="tel" name='tel'  @blur="v$.tel.$touch" required>
        
        </div>
        
        <div v-else> <input type="tel" placeholder="Numéro de téléphone*" v-model="tel" name='tel'  @blur="v$.tel.$touch" required></div>



<div v-if="v$.message.$error" class="error" >    <textarea name="message" id="message" cols="30" rows="10" placeholder="Champ obligatoire. *" v-model="message" @blur="v$.message.$touch" required></textarea>
