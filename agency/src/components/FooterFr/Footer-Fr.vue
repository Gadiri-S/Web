<template>
<div class="wrapper">
<div v-if="data" v-motion-fade class="footer">
...
<li> <router-link to ='/solutions'>Solutions</router-link> </li>
        <li> <router-link to ='/process'>Processus</router-link> </li>
...
async getInfos(){
    ...
    try{
const response = await axios.get('information?locale=fr&populate=*');
