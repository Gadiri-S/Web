...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Pour toute question, contactez-nous!</h1>
<span>Vous pouvez nous contacter en remplissant le formulaire ci-dessous ou directement par téléphone.</span>

<div class="button-container" ><button   @click="nav('container-contact')"  class="bu">Contactez-nous !</button></div>
</div>
<img  v-motion-fade  src="../../assets/microsoft-365-TLiWhlDEJwA-unsplash.jpg" class="hero-image" alt="">
    ...
    { name: 'description', content: description.value },
        { name: 'og:description', content: description.value},
         ...
         { name: 'og:image', content: image.value },
          { name: 'og:url', content: "https://businessprowebsolutions.com/contact" },
...
const res = await axios.get('contact-page?populate=deep')
