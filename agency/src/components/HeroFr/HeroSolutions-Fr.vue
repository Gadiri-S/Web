...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Des solutions web modernes et abordables pour booster votre entreprise</h1>
<span>Nos solutions webs sont adaptées aux besoins des entreprises qui comprennent la nécessité d'avoir une présence en ligne.</span>

<div class="button-container" ><button   @click="nav('container-page')"  class="bu">Voir nos solutions</button></div>
</div>
<img  v-motion-fade  src="../../assets/kitchen.webp" class="hero-image" alt="">
...
import Header from '../HeaderFr/Header-Fr.vue'
    ...
    { name: 'description', content: description.value },
        { name: 'og:description', content: description.value},
         ...
         { name: 'og:image', content: image.value },
                  { name: 'og:url', content: "https://businessprowebsolutions.com/solutions-fr" },
          { name: 'keywords', content: "https://businessprowebsolutions.com/solutions-fr" },
...
const res = await axios.get('solution-page?locale=fr&populate=deep')
