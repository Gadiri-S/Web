...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Une méthode de travail flexible et cohérente pour créer votre site web</h1>
<span>Notre méthode de travail a pour principal but de rapidement et efficacement répondre à tous vos besoins.</span>

<div class="button-container" ><button   @click="nav('container-page')"  class="bu">Découvrir les étapes</button></div>
</div>
...
const res = await axios.get('process-page?locale=fr&populate=deep')
