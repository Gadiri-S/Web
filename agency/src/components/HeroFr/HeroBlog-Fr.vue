...
<div class="hero-container">
  ...
  <div  class="container">
    <div class="text">
<h1><img src="../../assets/star.png" class="star" alt="">Lisez nos derniers articles et actualités</h1>
<span>Lisez nos derniers articles et actualités concernant le monde du développement web et ses liens au monde de l'entreprise!</span>

<div class="button-container" ><button   @click="nav('container-blog')"  class="bu">Voir nos articles et actualités</button></div>
</div>
<img  v-motion-fade  src="../../assets/kevin-bhagat-zNRITe8NPqY-unsplash.jpg" class="hero-image" alt="">
    ...
    { name: 'description', content: description.value },
        { name: 'og:description', content: description.value},
         ...
         { name: 'og:image', content: image.value },
                  { name: 'og:url', content: "https://businessprowebsolutions.com/blog" },
...
const res = await axios.get('blog-page?locale=fr&populate=deep')
