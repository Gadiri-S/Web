...
<router-link to ='/fr'>   <img  src="../../assets/logo-mini.webp"  class="logo-img" alt=""></router-link>

</div>
<router-link to='/en'> <img src="../../assets/uk.webp" class="lang" alt=""> </router-link>
...
<div v-if="show" class="nav-menu-mobile">
    <ul>
        <li> <router-link to ='/solutions-fr'> Nos solutions</router-link> </li>
        <li> <router-link to ='/processus'>Le processus</router-link> </li>
        <li> <router-link to ='/blog-fr'>  Blog </router-link> </li>
        <li> <router-link to ="/contact-fr">Contact</router-link> </li>
...
<div>
<button><router-link to ="/contact-fr">Démarrer</router-link> </button>
</div>
</div> 
</div>
</template>
