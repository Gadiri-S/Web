...
/></p>
  ...
  <h1>Some examples of professionnal websites</h1>
...
document.querySelector('.background1').style.backgroundImage=`url(${imageUrl}${response.gallery.data[4].attributes.url})`
document.querySelector('.background2').style.backgroundImage=`url(${imageUrl}${response.gallery.data[1].attributes.url})`
document.querySelector('.background3').style.backgroundImage=`url(${imageUrl}${response.gallery.data[3].attributes.url})`
document.querySelector('.background4').style.backgroundImage=`url(${imageUrl}${response.gallery.data[2].attributes.url})`
  document.querySelector('.backgroundLarge1').style.backgroundImage=`url(${imageUrl}${response.gallery.data[0].attributes.url})`
  ...
  Sentry.captureException(error);
   ...
   async getDetails(link){
      ...
      try{
            const res = await axios.get(`${link}?populate=*`);
    ...
    async getWebsites(link){
      ...
      try{
const res = await axios.get(`business-solutions?populate=*`);
