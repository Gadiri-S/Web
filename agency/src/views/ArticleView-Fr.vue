...
<p>{{description}}</p>
<div class="read-container" @click="nav('content')"> <img src="../assets/glasses.png" class="icon" alt="">   <span>Lire</span></div>
</div>
    <div v-motion-fade class="picture">
<img :src="image" class="hero-image" alt="">
    ...
    getParams(){
      ...
      this.params = params;
        const id  = this.$route.params.id;
          ...
          try{
          const response = await axios.get(`${apiUrl}/blogs/${id}/?locale=fr&populate=*`);
